...
public:
    ...
    SimpleParticles( const std::string& filename, const sf::Rect<int>& rect, unsigned n = 1 )
        :
        speed(10),
        windowWidth(100),
        windowHeight(100),
    ...
    void add( const std::string& filename, const sf::Rect<int>& rect, unsigned n = 1 )
    {
    ...
    void update()
    {
        ...
        {
            sprites[it].move(std::cos(angles[it]) * speed, std::sin(angles[it]) * speed);

            if( sprites[it].getPosition().x - sprites[it].getOrigin().x * 2 < 0 )
            {
                angles[it] = PI - angles[it];
                sprites[it].setPosition(sprites[it].getOrigin().x * 2 + 1, sprites[it].getPosition().y);
            }
            if( sprites[it].getPosition().x + sprites[it].getOrigin().x * 2 > windowWidth )
            {
                angles[it] = PI - angles[it];
                sprites[it].setPosition(windowWidth - sprites[it].getOrigin().x * 2 + 1, sprites[it].getPosition().y);
            }
            if( sprites[it].getPosition().y - sprites[it].getOrigin().y * 2 < 0 )
            {
                angles[it] = -angles[it];
                sprites[it].setPosition(sprites[it].getPosition().x, sprites[it].getOrigin().y * 2 + 1);
            }
            if( sprites[it].getPosition().y + sprites[it].getOrigin().y * 2 > windowHeight )
            {
                angles[it] = -angles[it];
                sprites[it].setPosition(sprites[it].getPosition().x, windowHeight - sprites[it].getOrigin().y * 2 + 1);
            }
